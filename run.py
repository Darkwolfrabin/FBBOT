...
def baner():
    ...
    print(f"""
     ...
     {rgb}╚═╝{W}└─┘ ┴ {rgb} ╚  {W}┴ ┴└─┘└─┘└─┘└─┘└─┘┴ ┴
{ab}-----------------------------------------------
{W}AUTHOR    : {rgb}DARK WOLF HACKING- RABIN-DAD
{W} Warning  : {W}I am not responsible for missed used 
{W}Message  : {rgb}https://www.facebook.com/master.mafia22
{W} TELEGRAM  : {rgb}https://t.me/+jtrQODsUa2w1NTc1
{W}Youtube  : {rgb}NOT AVAILABLE ☠️
{W}Github   : {rgb}https://github.com/darkwolfrabin
{W}Facebook : {rgb}https://www.facebook.com/master.mafia22
{ab}-----------------------------------------------""")
