...
"""
Project : Bot FacebooK BY DARK WOLFk
Author  : DARK WOLF RABIN
...
{rgb}AUTHOR : RABIN
FACEBOOK : RABIN
GITHUB : Darkwolfrabin
{Y}Note : THIS TOOL IS ONLY MADE FOR ENTERTAINMENT PURPOSE, DON'T MISSUSE OF THIS TOOL
{B}=============================================================={W}""")
...
def cblg():
    ...
    if lg == "y" or lg == "Y":
       ...
       exit(f"{er}Bye bro SHARE MY TOOL WITH YOUR FRIENDS :)")
       os.system("xdg-open https://www.facebook.com/profile.php?id=100064038878750")
    else:
       print(f"{er}Choose the right!")
       cblg()
...
def menu():
    baner()
    userinfo()
    print(f"{rgb}01{ab}. {Y}spam react\n{rgb}02{ab}. {Y}spam comment\n{rgb}03{ab}. {Y}spam message\n{rgb}04{ab}. {Y}auto accept request friend\n{rgb}05{rgb}. {Y}auto reject request friend\n{rgb}06{ab}. {Y}auto unadd not unfriend\n{rgb}07{ab}. {Y}auto unfriend\n{rgb}08{ab}. {Y}auto delete message\n{rgb}09{ab}. {Y}auto delete post\n{rgb}10{ab}. {Y}auto post\n{rgb}11{ab}. {Y}auto add friend\n{rgb}12{ab}. {Y}find group\n{rgb}13{ab}. {Y}find people\n{rgb}14{ab}. {Y}download vidio\n{rgb}15{ab}. {Y}remove cookies\n{rgb}00{ab}. {Y}exit\n{B}=============================================================={W}")
    pilih_menu()
...
def pilih_menu():
    ...
    if choice == "00" or choice == "0":
       baner()
       sys.exit(f"{er} THANKS FOR USING MY TOOL")
       os.system("xdg-open https://www.facebook.com/profile.php?id=100064038878750")
